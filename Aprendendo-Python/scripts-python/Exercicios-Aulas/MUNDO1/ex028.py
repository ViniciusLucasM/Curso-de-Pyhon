...
# Essa biblioteca serve para fazer o computador demorar um
# pouco para executar o proximo comando.
...
if jogador == computador:
    ...
    print('\033[1;33mPERDEU, VOCÊ NÃO CONSEGUIU ADIVINHAR'
          'O NÚMERO! O NÚMERO QUE EU TINHA PENSADO'
          'ERA {}\033[m'.format(computador))
